...
export function LeadForm() {
  ...
  const fieldClass =
    "mt-2 w-full rounded-xl border border-line bg-ivory px-4 py-3.5 text-[0.9375rem] text-charcoal transition-colors duration-400 placeholder:text-ink-faint hover:border-gold/40 focus:border-gold focus:outline-none";
  ...
  return (
    <SectionShell id="contact-form" tone="ivory" hairline>
        ...
        <div className="mx-auto max-w-2xl">
          ...
          <Reveal delay={160}>
            <form
              ...
              noValidate
              className="marry-card mt-10 p-6 sm:mt-12 sm:p-9"
            >
              ...
              <div className="mt-6">
                <label htmlFor={`${baseId}-collection`} className={labelClass}>
                  {leadForm.collectionLabel}
                </label>
                <div className="relative">
                  ...
                  >
                    <option value="">{leadForm.collectionPlaceholder}</option>
