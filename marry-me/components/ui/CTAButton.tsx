...
const variantClasses: Record<CTAVariant, string> = {
  ...
  outline:
    "border border-gold/45 text-charcoal hover:border-gold hover:bg-champagne",
  ghost:
    "border border-warm-white/35 text-warm-white hover:border-warm-white/70 hover:bg-warm-white/10",
  inverse:
    "btn-sheen bg-warm-white text-charcoal border border-warm-white hover:bg-ivory",
};
