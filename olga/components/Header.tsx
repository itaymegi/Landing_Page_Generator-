...
export function Header({ variant = "default" }: HeaderProps) {
  ...
  return (
    ...
    >
      <div className="container-olga flex h-14 min-h-14 items-center justify-between gap-2 sm:h-16 sm:gap-3 lg:h-[4.5rem] lg:gap-4">
        ...
        <div className="flex shrink-0 items-center gap-0.5 sm:gap-1 md:gap-2">
          ...
          <a
            href={siteWhatsAppHref("שלום אולגה, אשמח לתאם שיחת התאמה.")}
            target="_blank"
