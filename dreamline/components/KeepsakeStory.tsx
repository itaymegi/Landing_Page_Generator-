...
export function KeepsakeStory() {
  ...
  return (
    <section id="keepsake-story" className="section-py overflow-x-clip bg-peach/10">
      <div className="container-dreamline grid items-center gap-12 lg:grid-cols-2 lg:gap-20">
        <Reveal className="order-2 lg:order-1">
          ...
          {keepsakeStory.paragraphs.map((paragraph, index) => (
            <p
        ...
        <Reveal delay={120} className="relative order-1 overflow-hidden pb-10 ps-6 sm:pb-12 sm:ps-10 lg:order-2">
