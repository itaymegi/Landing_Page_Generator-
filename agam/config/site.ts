...
export const site: SiteConfig = {
  ...
  about: {
    ...
    credentials: [
      { value: "9", label: "שנות עיסוק ברפואה אסתטית" },
      { value: "5,000", label: "טיפולים שבוצעו בקליניקה" },
      { value: "12", label: "השתלמויות בארץ ובעולם" },
    ],
    signature: "אגם",
  ...
  why: {
    ...
    subtitle: "ארבעה עקרונות שמלווים כל טיפול, מהייעוץ ועד המעקב.",
    ...
    items: [
      {
        ...
        title: "דיוק רפואי",
        description:
          "עבודה לפי אנטומיה, במינונים מדודים ובנקודות מדויקות.",
      },
      {
        id: "natural",
        title: "תוצאות טבעיות",
        description:
          "איזון, לא שינוי — שומרים על ההבעה ועל הזהות של הפנים.",
      },
      {
        id: "personal",
        title: "טיפול מותאם אישית",
        description:
          "תכנית סביב מבנה הפנים והקצב שלך, לא סביב חבילה קבועה.",
      },
      {
        id: "consultation",
        title: "ייעוץ מקצועי",
        description:
          "פגישת היכרות כנה, כולל המלצה שלא לטפל כשזו התשובה הנכונה.",
      },
    ],
    standard: {
  ...
  faq: {
    eyebrow: "FAQ",
    title: "שאלות נפוצות",
    subtitle: "התשובות שאנחנו נשאלות הכי הרבה בפגישות הייעוץ.",
    items: [
      {
        question: "האם הטיפול כואב?",
        answer:
          "רוב הטיפולים נסבלים היטב. לפני הזרקות שפתיים או אזורים רגישים מורחים משחת הרדמה מקומית, ובחומרי המילוי עצמם משולב חומר מאלחש. רוב המטופלות מתארות תחושת לחץ קצרה יותר מאשר כאב.",
      },
      {
        question: "כמה זמן נמשך הטיפול?",
        answer:
          "פגישת ייעוץ ראשונה נמשכת כ-30 דקות. הטיפול עצמו נמשך בדרך כלל בין 15 ל-45 דקות, בהתאם לאזור ולהיקף.",
      },
      {
        question: "מתי אפשר לחזור לשגרה?",
        answer:
          "אפשר לחזור לשגרה מיד לאחר רוב הטיפולים. ייתכן אודם קל או נפיחות שחולפים תוך 24 עד 72 שעות. מומלץ להימנע ממאמץ גופני, סאונה וחשיפה לשמש במשך יומיים.",
      },
      {
        question: "מתי רואים תוצאות וכמה זמן הן נשארות?",
        answer:
          "בחומרי מילוי רואים שינוי מיידי שמתייצב תוך שבועיים. בבוטוקס התוצאה מופיעה בהדרגה תוך 3 עד 14 יום. משך התוצאה נע בין 4 חודשים לשנתיים, בהתאם לחומר, לאזור ולמטבוליזם האישי.",
      },
      {
        question: "האם התוצאה תיראה מלאכותית?",
        answer:
          "הגישה בקליניקה היא מינון מדוד ובנייה הדרגתית. במקרים רבים נעדיף לפצל טיפול לשתי פגישות כדי לראות איך התוצאה יושבת, במקום להגיע ליעד בפגישה אחת.",
      },
      {
        question: "באילו חומרים אתם משתמשים?",
        answer:
          "רק בחומרים מקוריים של מותגים מובילים ומאושרים רפואית — בהם Radiesse, Sculptra ו-aesPLLA, לצד חומצות היאלורוניות מיצרנים מוכרים. כל טיפול מתועד, כולל שם החומר ומספר האצווה.",
      },
      {
        question: "האם יש מצבים שבהם לא מומלץ לבצע טיפול?",
        answer:
          "כן. הריון והנקה, זיהום פעיל באזור הטיפול, מחלות אוטואימוניות מסוימות ונטילת מדללי דם מסוימים מחייבים דחייה או בדיקה מקדימה. כל אלה נבדקים בפגישת הייעוץ.",
      },
      {
        question: "מה כוללת פגישת הייעוץ?",
        answer:
          "בירור רפואי, בחינת מבנה הפנים, הצגת אפשרויות ריאליות והמלצה. הפגישה אינה מחייבת ביצוע טיפול, וגם המלצה שלא לטפל היא תשובה לגיטימית.",
      },
      {
        question: "איפה נמצאת הקליניקה?",
        answer:
          "הקליניקה נמצאת באילן רמון 5, נס ציונה. הפגישות בתיאום מראש בלבד.",
      },
    ],
  },
  leadForm: {
