...
export function FAQ() {
  ...
  return (
    <section id="faq" className="bg-parchment pt-10 pb-[4.5rem] sm:pt-14 sm:pb-[6.25rem] lg:pb-[8.75rem]">
          ...
          {faq.items.map((item, index) => (
            <Reveal key={item.question} delay={index * 60}>
              <details className="group border-b border-brown/10 py-5">
                <summary className="cursor-pointer list-none text-lg font-medium text-brown transition-colors marker:content-none hover:text-gold-deep sm:text-xl [&::-webkit-details-marker]:hidden">
